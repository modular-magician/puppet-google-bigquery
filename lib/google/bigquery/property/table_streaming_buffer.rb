    ...
    module Data
      ...
      class TableStreamingbufferApi < TableStreamingbuffer
        def initialize(args)
          ...
          @oldest_entry_time =
            Google::Bigquery::Property::Integer.api_munge(args['oldestEntryTime'])
        end
      end
      ...
      class TableStreamingbufferCatalog < TableStreamingbuffer
        def initialize(args)
          ...
          @estimated_rows = Google::Bigquery::Property::Integer.unsafe_munge(args['estimated_rows'])
          @oldest_entry_time =
            Google::Bigquery::Property::Integer.unsafe_munge(args['oldest_entry_time'])
        end
      end
    end
